...
pub mod functions {
    ...
    pub unsafe fn BeginConditionalRender(id: GLuint, mode: GLenum) -> () {
        mem::transmute::<_, extern "system" fn(GLuint, GLenum) -> ()>(
            storage::BeginConditionalRender.ptr,
        )(id, mode)
    }
    #[inline]
    ...
    pub unsafe fn BindFragDataLocation(program: GLuint, color: GLuint, name: *const GLchar) -> () {
        mem::transmute::<_, extern "system" fn(GLuint, GLuint, *const GLchar) -> ()>(
            storage::BindFragDataLocation.ptr,
        )(program, color, name)
    }
    #[inline]
    ...
    pub unsafe fn ClampColor(target: GLenum, clamp: GLenum) -> () {
        mem::transmute::<_, extern "system" fn(GLenum, GLenum) -> ()>(storage::ClampColor.ptr)(
            target, clamp,
        )
    }
    #[inline]
    ...
    pub unsafe fn ClearDepth(depth: GLdouble) -> () {
        mem::transmute::<_, extern "system" fn(GLdouble) -> ()>(storage::ClearDepth.ptr)(depth)
    }
    #[inline]
    ...
    pub unsafe fn ColorMaski(
        ...
        >(storage::ColorMaski.ptr)(index, r, g, b, a)
    }
    #[inline]
    ...
    pub unsafe fn CompressedTexImage1D(
        ...
        >(storage::CompressedTexImage1D.ptr)(
            target,
            level,
            internalformat,
            width,
    ...
    pub unsafe fn CompressedTexSubImage1D(
        ...
        >(storage::CompressedTexSubImage1D.ptr)(
    ...
    pub unsafe fn CopyTexImage1D(
        ...
        >(storage::CopyTexImage1D.ptr)(target, level, internalformat, x, y, width, border)
    }
    #[inline]
    ...
    pub unsafe fn DepthRange(n: GLdouble, f: GLdouble) -> () {
        mem::transmute::<_, extern "system" fn(GLdouble, GLdouble) -> ()>(storage::DepthRange.ptr)(
            n, f,
        )
    }
    #[inline]
    ...
    pub unsafe fn Disablei(target: GLenum, index: GLuint) -> () {
        mem::transmute::<_, extern "system" fn(GLenum, GLuint) -> ()>(storage::Disablei.ptr)(
            target, index,
        )
    }
    #[inline]
    ...
    pub unsafe fn DrawBuffer(buf: GLenum) -> () {
        mem::transmute::<_, extern "system" fn(GLenum) -> ()>(storage::DrawBuffer.ptr)(buf)
    }
    #[inline]
    ...
    pub unsafe fn DrawElementsBaseVertex(
        ...
        mem::transmute::<
            _,
            extern "system" fn(GLenum, GLsizei, GLenum, *const std::os::raw::c_void, GLint) -> (),
        >(storage::DrawElementsBaseVertex.ptr)(mode, count, type_, indices, basevertex)
    }
    #[inline]
    ...
    pub unsafe fn DrawElementsInstancedBaseVertex(
        ...
        >(storage::DrawElementsInstancedBaseVertex.ptr)(
            mode,
            count,
            type_,
            indices,
    ...
    pub unsafe fn DrawRangeElementsBaseVertex(
        ...
        >(storage::DrawRangeElementsBaseVertex.ptr)(
    ...
    pub unsafe fn Enablei(target: GLenum, index: GLuint) -> () {
        mem::transmute::<_, extern "system" fn(GLenum, GLuint) -> ()>(storage::Enablei.ptr)(
            target, index,
        )
    }
    #[inline]
    pub unsafe fn EndConditionalRender() -> () {
        mem::transmute::<_, extern "system" fn() -> ()>(storage::EndConditionalRender.ptr)()
    }
    #[inline]
    ...
    pub unsafe fn FramebufferTexture(
        ...
        mem::transmute::<_, extern "system" fn(GLenum, GLenum, GLuint, GLint) -> ()>(
            storage::FramebufferTexture.ptr,
    ...
    pub unsafe fn FramebufferTexture1D(
        ...
        mem::transmute::<_, extern "system" fn(GLenum, GLenum, GLenum, GLuint, GLint) -> ()>(
            storage::FramebufferTexture1D.ptr,
    ...
    pub unsafe fn FramebufferTexture3D(
        ...
        mem::transmute::<_, extern "system" fn(GLenum, GLenum, GLenum, GLuint, GLint, GLint) -> ()>(
            storage::FramebufferTexture3D.ptr,
    ...
    pub unsafe fn GetActiveUniformName(
        ...
        mem::transmute::<
            _,
            extern "system" fn(GLuint, GLuint, GLsizei, *mut GLsizei, *mut GLchar) -> (),
        >(storage::GetActiveUniformName.ptr)(
    ...
    pub unsafe fn GetBufferSubData(
        ...
        mem::transmute::<
            _,
            extern "system" fn(GLenum, GLintptr, GLsizeiptr, *mut std::os::raw::c_void) -> (),
        >(storage::GetBufferSubData.ptr)(target, offset, size, data)
    }
    #[inline]
    pub unsafe fn GetCompressedTexImage(
        ...
        mem::transmute::<_, extern "system" fn(GLenum, GLint, *mut std::os::raw::c_void) -> ()>(
            storage::GetCompressedTexImage.ptr,
        )(target, level, img)
    }
    #[inline]
    pub unsafe fn GetDoublev(pname: GLenum, data: *mut GLdouble) -> () {
        mem::transmute::<_, extern "system" fn(GLenum, *mut GLdouble) -> ()>(
            storage::GetDoublev.ptr,
        )(pname, data)
    }
    #[inline]
    ...
    pub unsafe fn GetSynciv(
        ...
        >(storage::GetSynciv.ptr)(sync, pname, count, length, values)
    }
    #[inline]
    pub unsafe fn GetTexImage(
        ...
        mem::transmute::<
            _,
            extern "system" fn(GLenum, GLint, GLenum, GLenum, *mut std::os::raw::c_void) -> (),
        >(storage::GetTexImage.ptr)(target, level, format, type_, pixels)
    }
    #[inline]
    pub unsafe fn GetTexLevelParameterfv(
        ...
        mem::transmute::<_, extern "system" fn(GLenum, GLint, GLenum, *mut GLfloat) -> ()>(
            storage::GetTexLevelParameterfv.ptr,
    ...
    pub unsafe fn GetTexParameterIuiv(target: GLenum, pname: GLenum, params: *mut GLuint) -> () {
        mem::transmute::<_, extern "system" fn(GLenum, GLenum, *mut GLuint) -> ()>(
            storage::GetTexParameterIuiv.ptr,
        )(target, pname, params)
    }
    #[inline]
    ...
    pub unsafe fn LogicOp(opcode: GLenum) -> () {
        mem::transmute::<_, extern "system" fn(GLenum) -> ()>(storage::LogicOp.ptr)(opcode)
    }
    #[inline]
    pub unsafe fn MapBuffer(target: GLenum, access: GLenum) -> *mut std::os::raw::c_void {
        mem::transmute::<_, extern "system" fn(GLenum, GLenum) -> *mut std::os::raw::c_void>(
            storage::MapBuffer.ptr,
        )(target, access)
    }
    #[inline]
    ...
    pub unsafe fn MultiDrawElements(
        ...
        >(storage::MultiDrawElements.ptr)(mode, count, type_, indices, drawcount)
    }
    #[inline]
    pub unsafe fn MultiDrawElementsBaseVertex(
        ...
        >(storage::MultiDrawElementsBaseVertex.ptr)(
            mode, count, type_, indices, drawcount, basevertex,
        )
    }
    #[inline]
    pub unsafe fn PixelStoref(pname: GLenum, param: GLfloat) -> () {
        mem::transmute::<_, extern "system" fn(GLenum, GLfloat) -> ()>(storage::PixelStoref.ptr)(
            pname, param,
        )
    }
    #[inline]
    ...
    pub unsafe fn PointParameterf(pname: GLenum, param: GLfloat) -> () {
        mem::transmute::<_, extern "system" fn(GLenum, GLfloat) -> ()>(storage::PointParameterf.ptr)(
            pname, param,
        )
    }
    #[inline]
    pub unsafe fn PointParameterfv(pname: GLenum, params: *const GLfloat) -> () {
        mem::transmute::<_, extern "system" fn(GLenum, *const GLfloat) -> ()>(
            storage::PointParameterfv.ptr,
        )(pname, params)
    }
    #[inline]
    pub unsafe fn PointParameteri(pname: GLenum, param: GLint) -> () {
        mem::transmute::<_, extern "system" fn(GLenum, GLint) -> ()>(storage::PointParameteri.ptr)(
            pname, param,
        )
    }
    #[inline]
    pub unsafe fn PointParameteriv(pname: GLenum, params: *const GLint) -> () {
        mem::transmute::<_, extern "system" fn(GLenum, *const GLint) -> ()>(
            storage::PointParameteriv.ptr,
        )(pname, params)
    }
    #[inline]
    pub unsafe fn PointSize(size: GLfloat) -> () {
        mem::transmute::<_, extern "system" fn(GLfloat) -> ()>(storage::PointSize.ptr)(size)
    }
    #[inline]
    pub unsafe fn PolygonMode(face: GLenum, mode: GLenum) -> () {
        mem::transmute::<_, extern "system" fn(GLenum, GLenum) -> ()>(storage::PolygonMode.ptr)(
            face, mode,
        )
    }
    #[inline]
    ...
    pub unsafe fn PrimitiveRestartIndex(index: GLuint) -> () {
        mem::transmute::<_, extern "system" fn(GLuint) -> ()>(storage::PrimitiveRestartIndex.ptr)(
            index,
        )
    }
    #[inline]
    ...
    pub unsafe fn TexImage2DMultisample(
        ...
        >(storage::TexImage2DMultisample.ptr)(
            target,
            samples,
            internalformat,
            width,
    ...
    pub unsafe fn TexImage3DMultisample(
        ...
        >(storage::TexImage3DMultisample.ptr)(
            target,
            samples,
            internalformat,
            width,
    ...
    pub unsafe fn TexSubImage1D(
        ...
        >(storage::TexSubImage1D.ptr)(target, level, xoffset, width, format, type_, pixels)
    }
    #[inline]
    ...
    pub unsafe fn VertexAttrib1d(index: GLuint, x: GLdouble) -> () {
        mem::transmute::<_, extern "system" fn(GLuint, GLdouble) -> ()>(storage::VertexAttrib1d.ptr)(
            index, x,
        )
    }
    #[inline]
    ...
    pub unsafe fn VertexAttrib1s(index: GLuint, x: GLshort) -> () {
        mem::transmute::<_, extern "system" fn(GLuint, GLshort) -> ()>(storage::VertexAttrib1s.ptr)(
            index, x,
        )
    }
    #[inline]
    ...
    pub unsafe fn VertexAttribI1iv(index: GLuint, v: *const GLint) -> () {
        mem::transmute::<_, extern "system" fn(GLuint, *const GLint) -> ()>(
            storage::VertexAttribI1iv.ptr,
        )(index, v)
    }
    #[inline]
    pub unsafe fn VertexAttribI1ui(index: GLuint, x: GLuint) -> () {
        mem::transmute::<_, extern "system" fn(GLuint, GLuint) -> ()>(storage::VertexAttribI1ui.ptr)(
            index, x,
        )
    }
    #[inline]
    ...
    F: FnMut(&'static str) -> *const raw::c_void,
{
    unsafe {
        ...
        storage::DrawElementsInstancedBaseVertex
            .load(&mut loadfn, "glDrawElementsInstancedBaseVertex");
